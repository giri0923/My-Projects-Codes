		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<c:if test="${not empty message}">
				  ...
				  <form:form method="post" action="editInternalUser" commandName="iDBean" class="form form-vertical">
            <div class="control-group">
              <label>Enter internal employee id </label>
              <div class="controls">
            ...
            <label> </label>
              <div class="controls">
                <input type="submit" value="Edit Internal User" class="btn btn-primary"/>
              </div>
            </div>   
          </form:form>
