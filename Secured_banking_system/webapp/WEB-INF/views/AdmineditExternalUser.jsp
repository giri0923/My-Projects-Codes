		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<c:if test="${not empty message}">
				  ...
				  <form:form method="post" action="editExternalUser" commandName="iDBean" class="form form-vertical">
            <div class="control-group">
              <label>Enter user id(only requested profile can be altered) </label>
              <div class="controls">
