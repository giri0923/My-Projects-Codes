	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Delete Internal User
				</h3>
				
				<hr>
				
				  <form:form method="post" action="deleteInternalUser.html" commandName="iDBean" class="form form-vertical">
            <div class="control-group">
              <label>Enter internal employee id to delete</label>
              <div class="controls">
