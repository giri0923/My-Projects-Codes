	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Add Internal User
				</h3>
		...
		<form:form method="post" action="addInternalUser.html" commandName="userBean" class="form form-vertical">
             ...
             <div class="control-group">
              ...
              <div class="controls">
               <form:select path="role" class="form-control">
    			<form:option value="ROLE_EMP" label="Employee"/>
			  </form:select>
              </div>
            </div>
            <div class="control-group">
