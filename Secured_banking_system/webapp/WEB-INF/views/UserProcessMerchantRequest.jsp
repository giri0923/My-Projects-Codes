	...
	<div id="top-nav" class="navbar navbar-inverse navbar-static-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="homepage.html">Home</a> <a class="navbar-brand"
				...
				<a class="navbar-brand" href="viewstatements.html">View Statements</a>
				<a class="navbar-brand" href="verifymerchantrequest.html">Make Payments</a>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Payement Requests from Merchants
				</h3>
				
				<hr>
				 <table class="table table-striped">
        		<thead>
        		  <tr><th>Transaction Type</th><th>From User (Merchant)</th><th>Transaction </th></tr>
        		</thead>
      		    <tbody>
      		    <c:forEach items="${list}" var="userRequest">
          		 ...
          		 <form:form method="post" action="userforwardtomerchant.html" class="form form-vertical">
          		 <td> 
