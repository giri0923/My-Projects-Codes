	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Edit External User Profile(only authorized user profiles can be edited)
				</h3>
				...
				<c:if test="${not empty message}">
				  ...
				  <form:form method="post" commandName="iDBean" action="EmployeeHandleRequests.html" class="form form-vertical">
            <div class="control-group">
              <label>Enter external user id - This is for authorization</label>
              <div class="controls">
