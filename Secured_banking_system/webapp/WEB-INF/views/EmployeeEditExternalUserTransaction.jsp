		...
		<div class="row">
			<div class="col-sm-3">
				...
				<ul class="nav nav-stacked">
						<li><a href="createtransaction.html?id=${id}"><i
							class="glyphicon glyphicon-book"></i> Handle Create Requests</a></li>
					<li><a href="deletetransaction.html?id=${id}">
					<i	class="glyphicon glyphicon-time"></i>Handle Delete Requests</a></li>
					<li><a href="modifytransaction.html?id=${id}"><i
							class="glyphicon glyphicon-book"></i> Handle Modify Request</a></li>
