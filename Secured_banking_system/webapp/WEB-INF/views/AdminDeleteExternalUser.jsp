	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Delete External User
				</h3>
				
				<hr>
				
				  <form:form method="post" action="deleteExternalUser.html" commandName="iDBean" class="form form-vertical">
