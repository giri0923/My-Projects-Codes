	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Add External User
				</h3>
		 ...
		 <form:form method="post" action="addExternalUser.html" commandName="userBean" class="form form-vertical">
            <div class="control-group">
              <label>First Name</label>
              <div class="controls">
                <form:input path="firstname" class="form-control" autocomplete="false" />
              </div>
            ...
            <div class="control-group">
              ...
              <font color="red"><form:errors path="lastname" autocomplete="false"/></font>
            </div> 
             <div class="control-group">
              <label>Mobile</label>
              <div class="controls">
                <form:input path="mobile" class="form-control" autocomplete="false"/>
              </div>
             ...
             <div class="control-group">
              <label>email</label>
              <div class="controls">
                <form:input path="email" class="form-control" autocomplete="false"/>
              </div>
             ...
             <div class="control-group">
              <label>Address</label>
              <div class="controls">
                <form:input path="address" class="form-control" autocomplete="false"/>
              </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
               <form:select path="role" class="form-control">
    			...
    			<form:option value="ROLE_MER" label="Merchant"/> <!-- chetan change -->
			  </form:select>
              </div>
            </div>  
            <div class="control-group">
