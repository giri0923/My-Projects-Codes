	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Handle Payment Requests
				</h3>
        		...
        		<thead>
      		    ...
      		    <c:forEach items="${list}" var="criticalTransaction">
          		 ...
          		 <form:form method="post" action="processPaymentTransactionsByAdmin.html" class="form form-vertical">
          		 <td> 
