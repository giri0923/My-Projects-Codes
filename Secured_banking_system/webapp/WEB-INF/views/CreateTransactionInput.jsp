	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Create Transaction : Credit Funds Securely (A request will be placed)
				</h3>

				<hr>
				<center>
 			<form:form method="post" commandName="iDBean" action="createtransactionrequest.html" class="form form-vertical" style="width:300px">
            <div class="control-group">
              <label>Please Enter Amount to be credited</label>
              <div class="controls">
