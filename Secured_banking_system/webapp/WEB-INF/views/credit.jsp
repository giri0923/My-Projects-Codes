	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h3>
					<i class="glyphicon glyphicon-dashboard"></i> Credit Funds Securely
				</h3>

				<hr>
				<center>
 			<form:form method="post" action="credit.html"  commandName="iDBean" class="form form-vertical" style="width:300px">
